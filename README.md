...
:musical_keyboard::musical_keyboard:**Note 3:** DroQ is used in [RoboPianist](https://kzakka.com/robopianist/) (it can learn to play [the Super Mario Bros.](https://drive.google.com/file/d/1wXDPTDfOuA_rG6GMwv7NJcELxc9gUOc-/view?usp=drive_link) and [Zelda](https://drive.google.com/file/d/1E2dnue0rSecbpVvyFcd6uO4jrGnik3Mx/view?usp=drive_link) theme songs in 400k samples)!!!:musical_keyboard::musical_keyboard:
